      ...
      content: [
...

        {
          ...
          table: {
            headerRows: 1,
            body: [
              [{ text: 'Cliente', bold: true, fontSize: 14 }, { text: this.clientDetails.entity.firstName, fontSize: 12,verticalAlignment: 'middle', bold: false }],
            ...
            ].filter(row => row[1].text && row[1].text.trim() !== ''),
          }
