...
export class Tab3Page {
  ...
  constructor(private router: Router, public contactApiService: ContactsTaskService,    public loadingController: LoadingController, public formsField: FormsService, private actionSheetService: ActionSheetService, public alertService: AlertService, public filterService: FilterServiceService, public tasksService: TasksService, public taskApiService: TaskApiService) {
  }
    ...
    if (test.id) {
      ...
      if (test.currentStatus.id == "e6875497-3ad4-4121-b3aa-4efde5d12fb1") {
        ...
        if (this.tasksService.notesTask && this.tasksService.notesTask.formInstances && this.tasksService.notesTask.formInstances.length > 0) {
          ...
          this.tasksService.turnDocuments = false;
